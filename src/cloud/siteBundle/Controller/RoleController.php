...
use cloud\siteBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('cloudBundle:Role')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('cloudBundle:Role')->find($id);
     ...
     * @Method("POST")
     * @Template("cloudBundle:Role:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("cloudBundle:Role:edit.html.twig")
     */
