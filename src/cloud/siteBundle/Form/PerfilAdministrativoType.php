...
class PerfilAdministrativoType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'cloud\siteBundle\Entity\PerfilAdministrativo'
        ));
    }

    public function getName()
    {
        return 'cloud_sitebundle_perfiladministrativotype';
    }
}
